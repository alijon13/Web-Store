    ...
    return (
        <div className="">
            <div className=" shadow-sm w-full fixed z-40 bg-[#fff] py-[30px]">
                <div className="  w-[73%] m-auto flex items-center mt-[0px] justify-between">
                    <div className="">
                        <Link to={"/"}>
                    ...
                    <Link to={'/Cotegory'}>
                        <div className="flex items-center hover:bg-[#ffe5a3] bg-[#FFBE1F] px-[15px] py-[12px] rounded-[8px] gap-[5px]">
                            <MenuIcon />
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="bg-[#FFBE1F] hover:bg-[#ffe5a3] px-[15px] py-[12px] rounded-tr-[8px] rounded-br-[8px]">
                    ...
                    <div className="flex gap-[15px]  items-center">
                        <div className="flex items-center cursor-pointer flex-col">
                            ...
                            <p className='text-[13px] text-[#73787D] font-[500] hover:text-[#FFBE1F]'>Душанбе</p>
                        </div>
                        <div className="flex items-center cursor-pointer flex-col">
                            ...
                            <p className='text-[13px] text-[#73787D] font-[500] hover:text-[#FFBE1F]'>Войти</p>
                        </div>
                        <Link to={'/Cart'}>
                        <div className="flex items-center cursor-pointer flex-col">
                            ...
                            <p className='text-[13px] text-[#73787D] hover:text-[#FFBE1F] font-[500]'>Корзина</p>
                        </div>
                        </Link>
                    </div>
                </div>
